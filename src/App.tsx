...
import PokeApi from "./api/pokemonList"
...
export default function() {
  ...
  <div className="flex justify-center items-center min-h-screen gap-2 flex-wrap p-4">
    {pokemonList.map(data => {
      ...
      const sprite = JSON.parse(pkm.spriteList[0].sprites).other["official-artwork"].front_default;
      const types = pkm.types.map(valor => {
